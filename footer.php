    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-9 d-flex justify-content-start mx-auto mt-3">
                    <p class="mx-1 fs-7">Privacy Policy</p>
                    <p class="mx-1 fs-7">Cookie Policy</p>
                    <p class="mx-1 fs-7">Contact us</p>
                </div>
