            ...
            <div class="col-10 col-md-6 col-lg-4 card custom-card mt-5">
                <div class="card-body">
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control cc mb-3" id="email" value=<?php if (isset($_COOKIE["email"])) {
                                                                                                echo ($_COOKIE["email"]);
                                                                                            } ?>>
                    </div>
                    <div class="">
                        ...
                        <input type="text" class="form-control cc mb-3" id="pw" value=<?php if (isset($_COOKIE["pw"])) {
                                                                                            echo ($_COOKIE["pw"]);
                                                                                        } ?>>
                    </div>
                    <div class="row">
                    ...
                    <div class="d-grid mt-4">
                        <button class="btn btn-light mb-3 rounded-5 fw-bold" onclick="adminLogIn();">Sign In</button>
                    </div>
