...
brandSelect.addEventListener("change", () => {
    brandSelect.selectedIndex > 0 ? brandId = brandSelect.value : brandId = null;
    loadProducts();
});
